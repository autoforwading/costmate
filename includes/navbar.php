...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4">
  <div class="container">
    <a class="navbar-brand fw-bold" href="/costmate/index.php">🏠 CostMate</a>
    ...
    <div class="collapse navbar-collapse" id="cmNav">
      ...
      <ul class="navbar-nav ms-auto">
        <!-- <li class="nav-item">
          <a class="btn btn-sm btn-outline-primary me-2" href="/costmate/pages/add_purchase.php">New Purchase</a>
        </li> -->
